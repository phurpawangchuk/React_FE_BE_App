...
import ApplicantDetailComponent from '../../component/ApplicantDetailComponent';
...
function ApplicationDetails() {
    ...
    const { data: fetchedData } = ApplicantDetailComponent(id);
    ...
    return (
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-2">
                        ...
                        <select
                            ...
                            className={`form-control is-valid`}
                        >
                            <option value={data.gender} defaultValue>{data.gender}</option>
        ...
        // <ApplicantDetailComponent id={id} />
    );
}
